...
function walkInTree(toNode, fromNode) {
    if (fromNode.children && fromNode.children.length > 0) {
        for (var j = 0; j < fromNode.children.length; j++) {
            var externalNode = getPackageNameAndVersion(fromNode.children[j].data);
            if (externalNode) {
                var newNode = {
                ...
                walkInTree(toNode.dependencies[toNode.dependencies.length - 1], fromNode.children[j], toNode);
            }
        }
    }
